...
export default function Index() {
  return (
    <div className="bg-[url('../img/cherry.gif')] bg-no-repeat bg-cover text-center py-24 bg-gray-100">
            <h1 className="animate-fade-down text-base mt-24 mb-12 text-5xl font-bold tracking-tight leading-7 text-pink-400">
              Angela Ung
            </h1>
            ...
            <ul className="pr-6 pl-6 mx-auto max-w-6xl py-4 divide-y divide-gray-100 mb-20 rounded-md border border-gray-200 bg-white">
              ...
              <li className="animate-fade-up text-center mb-20 content-center">
                <div className="flex justify-center mt-12 mb-12 text-pink-900 text-lg font-medium">
